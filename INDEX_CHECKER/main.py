...
def main():
    ...
    input_file = os.path.join(SCRIPT_DIR, 'input_domains.txt')   # Your input text file
    output_file = os.path.join(SCRIPT_DIR, 'output_results.csv') # Results file
    binary_file = os.path.join(SCRIPT_DIR, 'binary_results.csv') # Binary results file
    append_file = os.path.join(SCRIPT_DIR, 'historical_results.csv')  # File to append results to
